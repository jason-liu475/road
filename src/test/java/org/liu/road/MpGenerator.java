...
public class MpGenerator {
	final static String  dirPath = "D:\\code\\road\\src\\main\\java";
	...
	public static void main(String[] args) {
		...
		dsc.setUrl("jdbc:mysql://121.37.168.66:3306/zz_road?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true");
		...
		strategy.setInclude("sys_task"); // 需要生成的表
